...
A schematic overview of the architecture is shown in Fig.~\ref{fig:architecture}.
...
Table~\ref{tab:features} summarizes the key features of arbok-inspector compared to existing tools.
